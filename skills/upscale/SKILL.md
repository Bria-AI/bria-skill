...
RESULT_URL=$(bria_call /v2/image/edit/increase_resolution "IMAGE_PATH_OR_URL" '"scale": 2')
echo "$RESULT_URL"
```
...
If `bria_call` succeeds, `RESULT_URL` contains the upscaled image URL — show it to the user.
