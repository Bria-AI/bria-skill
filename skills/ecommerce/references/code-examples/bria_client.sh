...
#   RESULT=$(bria_call /v1/product/cutout "/path/to/image.png" --key file)
#   RESULT=$(bria_call /v1/product/packshot "https://example.com/img.png" --key image_url '"background_color":"#FFFFFF"')
#
