...
**Environment URLs:**
- Auth server: `https://engine.int.bria-api.com`
- Verification: `https://int.platform.bria.ai/device/verify`
...
- Otherwise, `BRIA_API_KEY` now contains the real API key. Proceed to the tool section.
